...
namespace ClaimRequest.BLL.Services.Interfaces
{
    public interface IClaimService
    {
        ...
        Task<PagingResponse<ViewClaimResponse>> GetClaims(int pageNumber = 1, int pageSize = 20, ClaimStatus? status = null, string? viewMode = null, string? filter = null, string? sortBy = "id", bool descending = false);
